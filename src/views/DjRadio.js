...
class DjRadio extends Component {
  constructor(props) {
    ...
    // 播放全部
    this.changeMusicList = this.changeMusicList.bind(this);
  }
  choosePage(page){
          ...
          <div className="g-mn4c">
            <div className="g-wrap6">
                ...
                <div className="cnt">
                  <div className="cntc">
                    ...
                    <div className="btns f-cb">
                      ...
                      <a onClick={this.changeMusicList} href="javascript:;" className="u-btni u-btni-playall">
                        <i>播放全部</i>
                      </a>
              ...
              <div className="n-songtb" id="songtb">
                ...
                <ProgramList {...this.props} programs={programs} page={Number(currPage)} order={Number(order)} total={Number(total)} />
