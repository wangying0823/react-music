	              ...
	              <div className="cnt">
	                <div className="cntc">
	                  ...
	                  <p className="intr f-brk" style={{ display: showMoreDesc ? 'none' : 'block' }}>
	                    <b>介绍：</b>
	                    {plDetail.description?<span dangerouslySetInnerHTML={{ __html: (plDetail.description.substring(0, 98) + '...').replace(/\n/g, '<br />') }} />:null}
	                  </p>
	                  <p className="intr f-brk" style={{ display: showMoreDesc ? 'block' : 'none' }}>
	                    <b>介绍：</b>
	                    {plDetail.description?<span dangerouslySetInnerHTML={{ __html: plDetail.description.replace(/\n/g, '<br />') }} />:null}
	                  </p>
	                  <div className={plDetail.description && plDetail.description.length <= 98 ? 'f-cb f-hide' : 'f-cb'}>
