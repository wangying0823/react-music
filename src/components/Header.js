		...
		render() {
			...
			if (!userInfo) {
				userBox = (<div className="m-dt pr">
					<a onClick={() => dispatch(chooseBox('登录'))} href="javascript:;" className="link">登录</a>
					<div className="dropdown-layer">
						<div className="inner">
							<ul className="dl-list clearfix">
								<li>
									<a onClick={() => dispatch(chooseBox('手机号登录'))} className="item-1" href="javascript:;">
								...
								<li>
									<a onClick={() => dispatch(chooseBox('邮箱登录'))} className="item-2" href="javascript:;">
...
// withRouter 将react-router 的 history,location,match 三个对象传入组件中
